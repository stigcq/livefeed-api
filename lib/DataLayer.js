...
exports.deleteMedia = function(userId, mediaId, callback) {
    ...
    runDbQuery(function(client, db) {
        var query = {"_id": ObjectID(mediaId), "user_id": userId};

        db.collection("media").deleteOne(query, function(err, ires) {
           
            if (err) throw err;
            console.log("1 media deleted id " + mediaId);
